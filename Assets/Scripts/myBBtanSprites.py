...
class Random(Powerup):
	...
	# Set image 
	self.image = pygame.image.load("random2.png")
	self.image = self.image.convert()
...
class Laser(Powerup):
	...
	# Set image 
	if buff == "up":
	    self.image = pygame.image.load("laser_up.png")
	else:
	    self.image = pygame.image.load("laser_side.png")
	self.image = self.image.convert()
...
class Beam(pygame.sprite.Sprite):
	...
	for num in range(1,4):
		...
		self.__image_list.append(pygame.image.load("Beam" + str(num) \
		                                           + ".png").convert())
	    else:
		self.__image_list.append(pygame.image.load("Beam" + \
...
class Player(pygame.sprite.Sprite):
	...
	if self.__shooting:
	    self.image = pygame.image.load("monkey2.png")
	else:
...
class Block(pygame.sprite.Sprite):
	...
	if self.__health > 19:
	    self.__image = "Block_yellow.png"
	    self.__color = (255,227,103)
	elif self.__health > 9:
	    self.__image = "Block_blue.png"
	    self.__color = (95,11, 208)
	else:
	    self.__image = "Block_red.png"
